...
WANDB_CONFIG = yaml.load(open("experiments/ADMOD_vs_HC/combined/raw/simple2d3layers.yaml"), Loader=yaml.FullLoader)
...
training_dataset = RawDataset(
    ...
    subjects_txt_path="experiments/ADMOD_vs_HC/combined/raw/splits/training_subjects.txt",
    normalize=config.normalize
)

validation_dataset = RawDataset(
    h5_file_path=H5_FILE_PATH,
    subjects_txt_path="experiments/ADMOD_vs_HC/combined/raw/splits/validation_subjects.txt",
    normalize=config.normalize
)
