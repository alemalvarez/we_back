...
DATASET_NAME = "hurh"  # Unique name for this dataset configuration
...
FOLDER_IDS = ["HURH"]
CATEGORIES = ["HC", "ADMIL", "ADMOD", "AD", "MCI"]  # List of categories to include
TEST_RATIO = 0.15  # Proportion for test set (rest goes to CV)
RANDOM_STATE = int(os.getenv("RANDOM_SEED", "42"))
OUTPUT_JSON = "universal_splits_tri.json"  # Path relative to this script's directory
